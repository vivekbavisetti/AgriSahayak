# AgriSahayak - Full Backend Source Code
...
# Use service_role key for backend operations (full access)
SUPABASE_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZld2VqZnFrY2t2cHhncGlwZnBzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MDM4NzcyOSwiZXhwIjoyMDg1OTYzNzI5fQ.9k2f7RGKnz-n2KbBysa9Ryi5uLMdDVzJA7ohRzSDENk
# Anon key (for frontend/public use): eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZld2VqZnFrY2t2cHhncGlwZnBzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzAzODc3MjksImV4cCI6MjA4NTk2MzcyOX0.TDGzEgOxVytaVXJ_vegoK2HgBOOs_oU9wkAVK6undSo

# JWT Configuration
SECRET_KEY=agrisahayak-super-secret-key-change-in-production
JWT_SECRET_KEY=agrisahayak-super-secret-key-change-in-production

# Database Configuration
# For development, use SQLite (set ALLOW_SQLITE=1 to suppress warning)
# For production, use: DATABASE_URL=postgresql://user:password@host:5432/dbname
# DATABASE_URL=postgresql+asyncpg://postgres:password@localhost:5432/agrisahayak
ALLOW_SQLITE=1

# Redis Configuration
REDIS_URL=redis://localhost:6379
# Gemini API Key (optional - for AI weather suggestions and market advisory)
...
# Sentinel-2 (Copernicus Data Space Ecosystem — free at dataspace.copernicus.eu)
SENTINEL_CLIENT_ID=
...
# Supabase (using REST API directly - no version conflicts)
requests==2.31.0

# ML & AI
# PyTorch CUDA wheels are hosted on the PyTorch index (not PyPI).
...
pqcrypto>=0.4.0
pycryptodome==3.19.0
# Optional NeoShield lattice implementation (preferred over fallback Falcon in NeoShield module)
dilithium-py>=0.1.3
...
# WhatsApp / Twilio (already present - ensure version)
twilio==8.11.1

# Web3 (lightweight - for parametric insurance ledger)
web3>=6.0.0
...
# Voice Assistant (optional - requires manual install)
# openai-whisper  # Run: pip install -U openai-whisper
# edge-tts  # Run: pip install edge-tts

# Image/GPS processing
exifread>=3.0.0

# WhatsApp integration (Twilio already included above)

```


## `backend/train_pest_classifier.py`


```python
"""
IP102 Pest Classification Training - Production Grade
Optimized for overnight training (5-6 hours) with CUDA + PyTorch

Dataset: IP102_3CLASS (3 pest categories, ~2150 images)
Architecture: EfficientNetV2-M with custom head
Expected Accuracy: 85-95% (3-class classification)

Usage:
    python train_pest_classifier.py
    
    # Background training (overnight):
    nohup python train_pest_classifier.py > training.log 2>&1 &
"""
...
try:
    ...
    print("⚠️ albumentations not installed. Using torchvision transforms.")
...
CONFIG = {
    # Dataset
    'dataset_name': 'IP102_3CLASS',
    'data_root': str(WORKSPACE_ROOT / 'IP102_3CLASS' / 'IP102_3CLASS'),
    'num_classes': 3,
    'class_names': ['Rice_leaf_roller', 'Grub', 'Prodenia_Litura'],
    
    # Model Architecture (adjusted for 6GB VRAM)
    'model_name': 'tf_efficientnetv2_s',  # Smaller than M for 6GB GPU
    # Fallback if timm not available: use torchvision resnet
    'pretrained': True,
    'input_size': 288,  # Reduced for 6GB VRAM (384 is too large)
    
    # Training Hyperparameters
    'epochs': 100,  # Good for overnight training
    ...
    'pin_memory': True,
    'persistent_workers': False,  # Can cause issues on Windows
    ...
    # Checkpointing
    'save_dir': str(WORKSPACE_ROOT / 'ml' / 'models' / 'pest_classifier'),
    'save_best_only': True,
...
# ============================================
# DATASET CLASS - FOLDER-BASED
# ============================================

class PestDataset(Dataset):
    """
    Pest Dataset Loader for folder-based structure
    ...
    def __init__(self, root_dir, transform=None):
        ...
        for idx, class_dir in enumerate(class_dirs):
            ...
            # Get all images in class folder (support multiple extensions)
            for ext in ['*.jpg', '*.jpeg', '*.png', '*.JPG', '*.JPEG', '*.PNG']:
                for img_path in class_dir.glob(ext):
                    self.samples.append((str(img_path), idx))
            
            logger.info(f"  Class {idx}: {class_name} - {sum(1 for s in self.samples if s[1] == idx)} images")
        
        logger.info(f"Total: {len(self.samples)} images across {len(self.class_to_idx)} classes")
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            if self.transform:
                blank = Image.new('RGB', (CONFIG['input_size'], CONFIG['input_size']), (0, 0, 0))
                if HAS_ALBUMENTATIONS and isinstance(self.transform, A.Compose):
            ...
            return torch.zeros(3, CONFIG['input_size'], CONFIG['input_size']), label
...
def get_train_transforms(config):
    ...
    if config['use_albumentations'] and HAS_ALBUMENTATIONS:
        return A.Compose([
            # Resize and crop
            A.LongestMaxSize(max_size=config['input_size'] + 32),
            A.PadIfNeeded(min_height=config['input_size'], min_width=config['input_size'], 
                          border_mode=0, value=(0, 0, 0)),
            A.RandomCrop(height=config['input_size'], width=config['input_size']),
            ...
            # Color transforms (important for pest distinction)
            A.OneOf([
            ...
            A.CoarseDropout(max_holes=8, max_height=32, max_width=32, 
                           fill_value=0, p=config['random_erasing']),
        ...
        # Torchvision transforms (fallback)
...
def get_val_transforms(config):
    ...
    if config['use_albumentations'] and HAS_ALBUMENTATIONS:
        return A.Compose([
            A.LongestMaxSize(max_size=config['input_size']),
            A.PadIfNeeded(min_height=config['input_size'], min_width=config['input_size'], 
                          border_mode=0, value=(0, 0, 0)),
...
# ============================================
# SUBSET WITH TRANSFORM (Module level for pickling)
# ============================================

class SubsetWithTransform(torch.utils.data.Subset):
    """Subset that preserves transforms for multiprocessing compatibility"""
    def __getitem__(self, idx):
...
class PestClassifier(nn.Module):
    """
    Pest Classifier with Transfer Learning
    Uses EfficientNetV2-S as backbone (or ResNet as fallback)
    """
    ...
    def __init__(self, config):
        ...
        if HAS_TIMM:
            # Use timm for EfficientNetV2
            logger.info(f"Loading pretrained {config['model_name']} from timm")
            self.backbone = timm.create_model(
                config['model_name'],
                pretrained=config['pretrained'],
                num_classes=0,  # Remove classifier head
                drop_rate=config['dropout'],
                drop_path_rate=config['droppath']
            )
            self.num_features = self.backbone.num_features
        else:
            # Fallback to torchvision ResNet50
            logger.info("Using torchvision ResNet50 (timm not available)")
        ...
        logger.info(f"Model created: backbone features = {self.num_features}, classes = {config['num_classes']}")
...
def get_criterion(config, class_weights=None):
    ...
    if config['use_focal_loss']:
        ...
        logger.info(f"Using CrossEntropyLoss (label_smoothing={config['label_smoothing']})")
...
def get_scheduler(optimizer, config, steps_per_epoch):
    ...
    logger.info(f"Using CosineAnnealing with {warmup_epochs} epoch warmup")
    return scheduler
...
class Trainer:
    """Pest Classification Training Manager"""
    ...
    def __init__(self, config):
        ...
        self.model = PestClassifier(config).to(self.device)
    ...
    def validate(self, val_loader, criterion, epoch):
        ...
        pbar = tqdm(val_loader, desc=f'Epoch {epoch}/{self.config["epochs"]} [Val]')
    ...
    def save_checkpoint(self, epoch, acc, class_to_idx, idx_to_class, is_best=False):
        ...
        # Save best model
        if is_best:
            best_path = save_dir / 'pest_classifier_best.pth'
            torch.save(state, best_path)
            logger.info(f"✅ New best model saved! Acc: {acc:.2f}%")
            
            # Also save a simplified version for inference
            inference_state = {
                'model_state_dict': self.model.state_dict(),
                'config': {
            ...
            inference_path = save_dir / 'pest_classifier_inference.pth'
            torch.save(inference_state, inference_path)
    
    def train(self, train_loader, val_loader, class_to_idx, idx_to_class):
        """Main training loop"""
        ...
        if class_counts.sum() > 0:
            ...
            class_weights = class_weights / class_weights.sum() * self.config['num_classes']
            logger.info(f"Class weights: {class_weights}")
        else:
            class_weights = None
        
        criterion = get_criterion(self.config, class_weights)
        optimizer = get_optimizer(self.model, self.config)
        
        steps_per_epoch = len(train_loader) // self.config['accumulation_steps']
        scheduler = get_scheduler(optimizer, self.config, steps_per_epoch)
        ...
        logger.info(f"Batch Size: {self.config['batch_size']} x {self.config['accumulation_steps']} = {self.config['batch_size'] * self.config['accumulation_steps']}")
        ...
        for epoch in range(1, self.config['epochs'] + 1):
            ...
            # Validate
            val_loss, val_acc, all_preds, all_labels = self.validate(val_loader, criterion, epoch)
            ...
            if is_best:
                ...
                self.epochs_without_improvement = 0
                self.save_checkpoint(epoch, val_acc, class_to_idx, idx_to_class, is_best=True)
            else:
            ...
            if epoch % self.config['save_every_n_epochs'] == 0:
                self.save_checkpoint(epoch, val_acc, class_to_idx, idx_to_class)
        
        logger.info("=" * 80)
        logger.info(f"🎉 TRAINING COMPLETE! Best Val Acc: {self.best_acc:.2f}%")
        logger.info("=" * 80)
        
        # Final evaluation
        self.final_evaluation(val_loader, criterion, class_to_idx, idx_to_class)
    ...
    def final_evaluation(self, val_loader, criterion, class_to_idx, idx_to_class):
        """Run final evaluation and save classification report"""
        _, _, all_preds, all_labels = self.validate(val_loader, criterion, self.config['epochs'])
    ...
    def plot_training_curves(self):
        ...
        plt.tight_layout()
        save_path = Path(self.config['save_dir']) / 'training_curves.png'
...
def main():
    ...
    logger.info("=" * 80)
    logger.info("🐛 IP102 PEST CLASSIFICATION TRAINING")
    logger.info("=" * 80)
    ...
    if not data_root.exists():
        ...
        logger.error("Please ensure IP102_3CLASS dataset is in the correct location.")
        return
    
    # Create full dataset
    logger.info(f"\n📂 Loading dataset from: {data_root}")
    full_dataset = PestDataset(
    ...
    CONFIG['class_names'] = [idx_to_class[i] for i in range(len(idx_to_class))]
    ...
    # Create a validation dataset with proper transforms
    val_transform_dataset = PestDataset(
        root_dir=CONFIG['data_root'],
        transform=get_val_transforms(CONFIG)
    )
    
    # Use indices from split
    ...
    val_loader = DataLoader(
        SubsetWithTransform(val_transform_dataset, val_indices),
    ...
    best_acc = trainer.train(train_loader, val_loader, class_to_idx, idx_to_class)
    
    logger.info("\n" + "=" * 80)
    logger.info("🎉 All done!")
    logger.info(f"   Best model saved at: {Path(CONFIG['save_dir']) / 'pest_classifier_best.pth'}")
...
def _strip_markdown(text: str) -> str:
    ...
    Preserves bullet points (• or –) and line breaks.
    """
    import re
    ...
    # Normalise list markers: "- item" or "* item" → "• item"
...
## `backend/app/analytics/duckdb_engine.py`
...
## `backend/app/api/v1/endpoints/camera.py`
...
## `backend/app/api/v1/endpoints/crop.py`
...
## `backend/app/api/v1/endpoints/cropcycle.py`
...
## `backend/app/api/v1/endpoints/defi.py`
...
## `backend/app/api/v1/endpoints/disease.py`
...
## `backend/app/api/v1/endpoints/disease_history.py`
...
## `backend/app/api/v1/endpoints/expense.py`
...
## `backend/app/api/v1/endpoints/farmer.py`
...
## `backend/app/api/v1/endpoints/fertilizer.py`
...
## `backend/app/api/v1/endpoints/logistics.py`
...
## `backend/app/api/v1/endpoints/outbreak_map.py`
...
## `backend/app/api/v1/endpoints/pest.py`
...
## `backend/app/api/v1/endpoints/pqc.py`
...
async def text_to_speech(text: str, language: str = "hi") -> bytes:
    ...
    voices = {
        ...
        "hi-male": "hi-IN-MadhurNeural",  # Hindi male voice
...
async def list_available_voices():
    ...
    return {
        "voices": [
            ...
            {"code": "hi-male", "name": "Hindi Male (Madhur)", "voice_id": "hi-IN-MadhurNeural"},
            {"code": "en", "name": "English Female (Neerja)", "voice_id": "en-IN-NeerjaNeural"},
            {"code": "en-male", "name": "English Male (Prabhat)", "voice_id": "en-IN-PrabhatNeural"},
...
## `backend/app/chatbot/ollama_client.py`
...
## `backend/app/chatbot/rag_engine.py`
...
## `backend/app/crypto/neoshield_pqc.py`
...
## `backend/app/crypto/neoshield_simulation.py`
...
## `backend/app/crypto/pq_signer.py`
...
## `backend/app/crypto/signature_service.py`
...
## `backend/app/external/market_api.py`
...
## `backend/app/external/weather_api.py`
...
## `backend/app/ml/models/crop_model.py`
...
## `backend/app/ml/models/disease_model.py`
...
## `backend/app/satellite/__init__.py`
...
## `backend/app/satellite/sentinel_service.py`
...
## `backend/data/knowledge/crops.json`
...
```json
{
  "Rice": {
    ...
    "duration": 120,
    "npk": {"N": 120, "P": 60, "K": 40},
    "water_requirement": "1200-1400 mm (flooded cultivation)",
    "soil_type": ["Clay", "Clay loam", "Alluvial"],
    "optimal_ph": "5.5-7.0",
    "spacing": "20x15 cm (transplanted), 20x10 cm (direct seeded)",
    "seed_rate": "20-25 kg/acre (transplanting), 30-35 kg/acre (DSR)",
    "key_stages": {
      "nursery": "21-30 days",
      "transplanting": "21-25 day seedlings",
      "tillering": "25-60 DAT",
      "flowering": "70-90 DAT",
      "maturity": "110-140 DAT"
    },
    "fertilizer_schedule": {
      "basal": "Full P, K + 1/3 N at transplanting",
      "first_top": "1/3 N at 21 DAT (tillering)",
      "second_top": "1/3 N at 45 DAT (panicle initiation)"
    },
    "common_diseases": ["Blast", "Bacterial Leaf Blight", "Sheath Blight", "Brown Spot"],
    "common_pests": ["Stem Borer", "Brown Plant Hopper", "Leaf Folder", "Gall Midge"]
  },
  "Wheat": {
    "hindi": "गेहूं",
    ...
    "duration": 120,
    "npk": {"N": 120, "P": 60, "K": 40},
    "water_requirement": "400-500 mm (4-6 irrigations)",
    "soil_type": ["Loam", "Clay loam", "Alluvial"],
    "optimal_ph": "6.0-7.5",
    "spacing": "22.5 cm row spacing",
    "seed_rate": "40-50 kg/acre",
    "key_stages": {
      "sowing": "November 1-25 (timely)",
      "germination": "7-10 DAS",
      "tillering": "30-45 DAS",
      "jointing": "60-70 DAS",
      "flowering": "80-90 DAS",
      "maturity": "120-150 DAS"
    },
    "fertilizer_schedule": {
      "basal": "Full P, K + 1/2 N at sowing",
      "first_top": "1/2 N at first irrigation (21 DAS)"
    },
    "critical_irrigation": ["CRI (21 DAS)", "Tillering (45 DAS)", "Jointing (70 DAS)", "Flowering (90 DAS)", "Dough (105 DAS)"],
    "common_diseases": ["Yellow Rust", "Brown Rust", "Karnal Bunt", "Loose Smut"],
    "common_pests": ["Aphids", "Army Worm", "Termites"]
  },
  "Maize": {
    "hindi": "मक्का",
    "season": "Kharif (June-October) and Rabi",
    "duration": 100,
    "npk": {"N": 120, "P": 60, "K": 60},
    "water_requirement": "500-600 mm",
    "soil_type": ["Loam", "Sandy loam", "Well-drained"],
    "optimal_ph": "5.5-7.5",
    "spacing": "60x20 cm",
    "seed_rate": "8-10 kg/acre (hybrid)",
    "key_stages": {
      "germination": "7-10 DAS",
      "knee_high": "30-35 DAS",
      "tasseling": "55-65 DAS",
    ...
    "fertilizer_schedule": {
      ...
      "first_top": "1/3 N at knee-high (30 DAS)",
      "second_top": "1/3 N at tasseling (55 DAS)"
    },
    "common_diseases": ["Maydis Leaf Blight", "Downy Mildew", "Stalk Rot"],
    "common_pests": ["Fall Army Worm", "Stem Borer", "Shoot Fly"]
  },
  "Cotton": {
    "hindi": "कपास",
    ...
    "duration": 180,
    "npk": {"N": 80, "P": 40, "K": 40},
    "water_requirement": "700-900 mm (6-8 irrigations)",
    "soil_type": ["Black cotton soil", "Deep loam", "Well-drained"],
    "optimal_ph": "6.0-8.0",
    "spacing": "90x60 cm (rainfed), 90x45 cm (irrigated)",
    "seed_rate": "1-1.5 kg/acre (Bt hybrid)",
    "key_stages": {
      "germination": "7-10 DAS",
      "squaring": "35-45 DAS",
      "flowering": "60-70 DAS",
      "boll_development": "80-120 DAS",
      "first_picking": "140-150 DAS"
    },
    "fertilizer_schedule": {
      "basal": "Full P, K + 1/4 N at sowing",
      "splits": "N in 3-4 splits up to 60 DAS"
    },
    "common_diseases": ["Bacterial Blight", "Leaf Curl Virus", "Grey Mildew"],
    "common_pests": ["American Bollworm", "Pink Bollworm", "Whiteflies", "Jassids", "Aphids"]
  },
  "Tomato": {
    "hindi": "टमाटर",
    "season": "Rabi/Summer (transplant Aug-Feb)",
    "duration": 120,
    "npk": {"N": 120, "P": 60, "K": 60},
    "water_requirement": "600-700 mm (drip/furrow)",
    "soil_type": ["Sandy loam", "Loam", "Well-drained"],
    "optimal_ph": "6.0-7.0",
    "spacing": "60x45 cm (determinate), 75x60 cm (indeterminate)",
    "seed_rate": "150-200 g/acre (nursery)",
    "key_stages": {
      "nursery": "25-30 days",
      "transplanting": "4-5 leaf stage",
      "flowering": "30-45 DAT",
      "fruiting": "60-75 DAT",
      "first_harvest": "70-90 DAT"
    },
    "fertilizer_schedule": {
      "basal": "FYM 10t/acre + Full P + 1/3 N, K",
      "top_dressing": "N, K at 30 DAT and 60 DAT"
    },
    "common_diseases": ["Late Blight", "Early Blight", "Bacterial Wilt", "Leaf Curl"],
    "common_pests": ["Fruit Borer", "Whiteflies", "Nematodes", "Aphids"]
  },
  "Potato": {
    "hindi": "आलू",
    "season": "Rabi (October-February)",
    "duration": 90,
    "npk": {"N": 120, "P": 80, "K": 100},
    "water_requirement": "500-600 mm (8-12 irrigations)",
    "soil_type": ["Sandy loam", "Loam", "Well-drained, friable"],
    "optimal_ph": "5.5-6.5",
    "spacing": "60x20 cm",
    "seed_rate": "600-800 kg/acre (25-40g tubers)",
    "key_stages": {
      "planting": "October 15-November 15",
      "emergence": "15-20 DAP",
      "stolonization": "30-35 DAP",
      "tuberization": "45-60 DAP",
      "maturity": "80-100 DAP"
    },
    "fertilizer_schedule": {
      "basal": "Full P, K + 1/2 N at planting",
      "top_dressing": "1/2 N at earthing up (25-30 DAP)"
    },
  ...
  "Onion": {
    "hindi": "प्याज",
    "season": "Rabi (Nov-May), Kharif (June-Jan)",
    "duration": 130,
    "npk": {"N": 50, "P": 25, "K": 50},
    "water_requirement": "450-550 mm",
    "soil_type": ["Sandy loam", "Loam", "Well-drained"],
    "optimal_ph": "6.0-7.0",
    "spacing": "15x10 cm",
    "seed_rate": "4-5 kg/acre (seedlings from 40-45 day nursery)",
    "key_stages": {
      "nursery": "40-45 days",
      "transplanting": "6-8 leaf stage",
      "bulb_initiation": "55-60 DAT",
      "bulb_development": "70-100 DAT",
      "maturity": "100-130 DAT"
    },
    "fertilizer_schedule": {
      "basal": "Full P, K + 1/2 N at transplanting",
      "top_dressing": "1/4 N at 30 DAT + 1/4 N at 45 DAT"
    },
  ...
  "Chickpea": {
    ...
    "duration": 120,
    "npk": {"N": 20, "P": 40, "K": 20},
    "water_requirement": "350-450 mm (1-3 irrigations)",
    "soil_type": ["Loam", "Clay loam", "Well-drained"],
    "optimal_ph": "6.0-8.0",
    "spacing": "30x10 cm",
    "seed_rate": "30-35 kg/acre (desi), 40-45 kg/acre (kabuli)",
    "key_stages": {
      "sowing": "October 15-November 15",
      "germination": "10-15 DAS",
      "branching": "25-30 DAS",
      "flowering": "40-55 DAS",
      "podding": "70-90 DAS",
      "maturity": "110-130 DAS"
    },
    "fertilizer_schedule": {
      "basal": "All NPK at sowing",
      "note": "Rhizobium seed treatment reduces N requirement"
    },
    "common_diseases": ["Fusarium Wilt", "Ascochyta Blight", "Dry Root Rot", "Collar Rot"],
    "common_pests": ["Pod Borer (Helicoverpa)", "Cutworm"]
  },
  "Sugarcane": {
    "hindi": "गन्ना",
    ...
    "duration": 360,
    "npk": {"N": 150, "P": 60, "K": 60},
    "water_requirement": "1500-2000 mm (25-30 irrigations)",
    "soil_type": ["Loam", "Clay loam", "Deep fertile"],
    "optimal_ph": "6.5-7.5",
    "spacing": "75-90 cm between rows",
    "seed_rate": "25,000-30,000 setts/acre (3-bud setts)",
    "key_stages": {
      "germination": "30-45 DAP",
      "tillering": "45-120 DAP",
      "grand_growth": "120-270 DAP",
      "maturity": "300-365 DAP"
    },
    "fertilizer_schedule": {
      "basal": "Full P, K + 1/3 N at planting",
      "first_top": "1/3 N at 45 DAP (tillering)",
      "second_top": "1/3 N at 90 DAP (earthing up)"
    },
    "common_diseases": ["Red Rot", "Smut", "Wilt", "Grassy Shoot"],
    "common_pests": ["Stem Borer", "Top Borer", "Pyrilla", "Termites"]
  },
  "Groundnut": {
    "hindi": "मूंगफली",
    "season": "Kharif (June-Oct), Rabi (Jan-May)",
    "duration": 110,
    "npk": {"N": 10, "P": 25, "K": 45},
    "water_requirement": "400-500 mm",
    "soil_type": ["Sandy loam", "Red sandy", "Well-drained"],
    "optimal_ph": "6.0-6.5",
    "spacing": "30x10 cm (bunch), 45x15 cm (spreading)",
    "seed_rate": "50-60 kg/acre (kernel)",
    "key_stages": {
      "germination": "7-10 DAS",
      "flowering": "30-40 DAS",
      "pegging": "45-55 DAS",
      "pod_development": "60-90 DAS",
      "maturity": "100-130 DAS"
    },
    "fertilizer_schedule": {
      "basal": "All NPK at sowing",
      "gypsum": "Apply 200 kg/acre at flowering",
      "note": "Being legume, needs less N (Rhizobium fixes N)"
    },
    "common_diseases": ["Tikka Disease", "Rust", "Collar Rot", "Stem Rot"],
    "common_pests": ["Aphids", "Thrips", "White Grub", "Leaf Miner"]
  },
  "Soybean": {
    "hindi": "सोयाबीन",
    ...
    "npk": {"N": 20, "P": 60, "K": 40},
    "water_requirement": "450-550 mm",
    "soil_type": ["Clay loam", "Loam", "Well-drained"],
    "optimal_ph": "6.0-7.0",
    "spacing": "45x5 cm (row x plant)",
    "seed_rate": "30-35 kg/acre",
    "key_stages": {
      "sowing": "June 20-July 10",
      "germination": "7-10 DAS",
      "flowering": "40-50 DAS",
      "pod_filling": "60-80 DAS",
      "maturity": "90-110 DAS"
    },
    "fertilizer_schedule": {
      "basal": "All NPK at sowing",
      "note": "Bradyrhizobium seed treatment important"
    },
    "common_diseases": ["Yellow Mosaic", "Anthracnose", "Pod Blight", "Charcoal Rot"],
    "common_pests": ["Stem Fly", "Girdle Beetle", "Tobacco Caterpillar", "Whiteflies"]
  },
  "Chilli": {
    "hindi": "मिर्च",
    "season": "Throughout year (main: June-July, Feb-March)",
    "duration": 180,
    "npk": {"N": 60, "P": 30, "K": 30},
    "water_requirement": "500-600 mm",
    "soil_type": ["Sandy loam", "Loam", "Well-drained"],
    "optimal_ph": "6.0-7.0",
    "spacing": "60x45 cm",
    "seed_rate": "200-250 g/acre (nursery)",
    "key_stages": {
      "nursery": "35-40 days",
      "transplanting": "5-6 leaf stage",
      "flowering": "45-60 DAT",
      "fruiting": "75-90 DAT",
      "first_harvest": "80-90 DAT"
    },
    "fertilizer_schedule": {
      "basal": "Full P + 1/3 N, K",
      "top_dressing": "At 30 and 60 DAT"
    },
    "common_diseases": ["Anthracnose", "Leaf Curl", "Damping Off", "Powdery Mildew"],
    "common_pests": ["Thrips", "Mites", "Fruit Borer", "Aphids"]
  },
  "Brinjal": {
    "hindi": "बैंगन",
    ...
    "key_stages": {
      ...
      "transplanting": "4-5 leaf stage",
      "flowering": "35-45 DAT",
      "first_harvest": "50-60 DAT"
    },
    "fertilizer_schedule": {
      "basal": "Full P + half N, K",
      "top_dressing": "At 30, 60, 90 DAT"
    },
    "common_diseases": ["Bacterial Wilt", "Little Leaf", "Phomopsis Blight"],
    "common_pests": ["Shoot and Fruit Borer", "Jassids", "Aphids", "Red Spider Mite"]
  },
  "Okra": {
    "hindi": "भिंडी",
    "season": "Summer (Feb-March), Rainy (June-July)",
    "duration": 90,
    "npk": {"N": 40, "P": 25, "K": 25},
    ...
    "key_stages": {
      "germination": "5-8 DAS",
      "flowering": "40-50 DAS",
      "first_harvest": "50-55 DAS"
    },
    "fertilizer_schedule": {
      "basal": "Full P, K + 1/2 N",
      "top_dressing": "1/2 N at 30 DAS"
    },
    "common_diseases": ["Yellow Vein Mosaic", "Powdery Mildew", "Damping Off"],
    "common_pests": ["Fruit Borer", "Jassids", "Aphids", "Mites"]
  },
  "Cabbage": {
    "hindi": "पत्ता गोभी",
    "season": "Rabi (Sept-Feb)",
    "duration": 100,
    "npk": {"N": 60, "P": 30, "K": 30},
    ...
    "key_stages": {
      "nursery": "30-35 days",
      "head_formation": "60-75 DAT",
      "harvest": "80-100 DAT"
    },
    "fertilizer_schedule": {
      "basal": "Full P, K + 1/2 N",
      "top_dressing": "1/2 N at 21 and 45 DAT"
    },
    "common_diseases": ["Black Rot", "Downy Mildew", "Club Root"],
    "common_pests": ["Diamondback Moth", "Cabbage Butterfly", "Aphids"]
  },
  "Cauliflower": {
    "hindi": "फूल गोभी",
    "season": "Rabi (Sept-Feb)",
    ...
    "key_stages": {
      "nursery": "30-35 days",
      "curd_initiation": "50-60 DAT",
      "harvest": "80-100 DAT"
    },
    "fertilizer_schedule": {
      "basal": "Full P, K + 1/2 N + Boron 2kg/acre",
      "top_dressing": "1/4 N at 21 DAT + 1/4 N at curd initiation"
    },
    "common_diseases": ["Black Rot", "Downy Mildew", "Hollow Stem (Boron deficiency)"],
    "common_pests": ["Diamondback Moth", "Aphids", "Cabbage Butterfly"]
  },
  "Mango": {
    "hindi": "आम",
    "season": "Perennial (flowering: Jan-Mar)",
    "duration": null,
    "npk": {"N": 1000, "P": 500, "K": 1000},
    "npk_note": "g/tree/year for 10-year-old tree",
    "water_requirement": "Critical irrigation at flowering and fruit development",
    "soil_type": ["Deep loam", "Alluvial", "Red laterite"],
    "optimal_ph": "5.5-7.5",
    "spacing": "10x10 m (traditional), 2.5x2.5 m (high density)",
    "key_stages": {
      "flowering": "January-February",
      "fruit_set": "February-March",
      "fruit_development": "April-May",
      "harvest": "May-July"
    },
    "fertilizer_schedule": {
      "application": "After harvest and before flowering",
      "organic": "50 kg FYM/tree"
    },
    "common_diseases": ["Powdery Mildew", "Anthracnose", "Malformation", "Die Back"],
    "common_pests": ["Mango Hopper", "Mealy Bug", "Fruit Fly", "Stone Weevil"]
  },
  "Banana": {
    "hindi": "केला",
    "season": "Planted: June-July or Oct-Nov",
    "duration": 420,
    "npk": {"N": 200, "P": 75, "K": 300},
    "npk_note": "g/plant",
    "water_requirement": "1800-2000 mm distributed through drip",
    "soil_type": ["Deep loam", "Clay loam", "Well-drained"],
    "optimal_ph": "6.5-7.5",
    "spacing": "1.8x1.8 m or 2x2 m",
    "key_stages": {
      "vegetative": "5-6 months",
      "shooting": "7-8 month",
      "bunch_development": "3-4 months",
      "harvest": "12-14 months"
    },
    "fertilizer_schedule": {
      "application": "Split application monthly through fertigation",
      "organic": "10-15 kg FYM/pit at planting"
    },
    "common_diseases": ["Panama Wilt", "Sigatoka Leaf Spot", "Anthracnose", "Bunchy Top (viral)"],
    "common_pests": ["Banana Weevil", "Pseudostem Weevil", "Thrips", "Nematodes"]
  },
  "Grapes": {
    "hindi": "अंगूर",
    "season": "Perennial (pruning: Oct for Nasik)",
    "duration": null,
    "npk": {"N": 500, "P": 300, "K": 500},
    "npk_note": "g/vine/year for mature vines",
    "water_requirement": "500-600 mm (drip irrigation)",
    "soil_type": ["Sandy loam", "Well-drained", "Rocky"],
    "optimal_ph": "6.5-7.5",
    "spacing": "3x1.5 m (Y-trellis)",
    "key_stages": {
      "Oct_pruning": "Foundation pruning",
      "bud_break": "7-10 days after pruning",
      "flowering": "21-28 days",
      "fruit_set": "35-40 days",
      "veraison": "60-70 days",
      "harvest": "100-110 days"
    },
    "fertilizer_schedule": {
      "basal": "FYM 50 kg + full P, K before pruning",
      "fertigation": "N in weekly splits"
    },
    "common_diseases": ["Powdery Mildew", "Downy Mildew", "Anthracnose"],
    "common_pests": ["Thrips", "Mealy Bug", "Flea Beetle"]
  }
}
...
## `backend/data/knowledge/diseases.json`
...
```json
{
  "Late Blight": {
    ...
    "causes": "Phytophthora infestans fungus, humid weather above 90%, cool temperatures 15-20°C",
    "treatment": "Mancozeb 75% WP @ 2g/L or Copper Oxychloride @ 3g/L or Metalaxyl + Mancozeb @ 2.5g/L. Spray every 7 days during wet weather.",
    "prevention": "Avoid overhead irrigation, ensure air circulation, use resistant varieties, remove infected debris, crop rotation",
    "severity": "critical"
  },
  "Early Blight": {
    "hindi": "अगेती अंगमारी",
    ...
    "causes": "Alternaria solani fungus, warm humid conditions 24-29°C",
    "treatment": "Chlorothalonil @ 2g/L or Mancozeb 75% WP @ 2.5g/L or Azoxystrobin @ 1ml/L. Apply every 10-14 days.",
    "prevention": "Crop rotation (3 years), remove infected debris, stake plants for air circulation, mulching",
    "severity": "moderate"
  },
  "Bacterial Wilt": {
    "hindi": "जीवाणु मुरझान",
    "crops": ["tomato", "potato", "eggplant", "pepper", "banana"],
    "symptoms": [
      "sudden wilting",
      "plants wilt during day recover at night initially",
      "brown vascular tissue",
      "milky bacterial ooze when stem is cut"
    ],
    "causes": "Ralstonia solanacearum bacteria, waterlogged soil, high temperatures",
    "treatment": "No effective chemical treatment. Remove and destroy infected plants. Apply Streptocycline 100ppm drench for prevention.",
    "prevention": "Use resistant varieties, crop rotation (5 years), avoid waterlogging, use disease-free seedlings",
    "severity": "critical"
  },
  "Powdery Mildew": {
    "hindi": "चूर्णिल आसिता",
    "crops": ["cucumber", "pumpkin", "bottle gourd", "pea", "okra", "grapes", "mango"],
    "symptoms": [
    ...
    "causes": "Fungal spores (Erysiphe, Podosphaera), dry conditions, moderate temperature 20-25°C",
    "treatment": "Sulphur 80% WP @ 2g/L or Carbendazim @ 1g/L or Triadimefon @ 0.5g/L. Spray at first sign.",
    "prevention": "Avoid overcrowding, ensure ventilation, avoid evening irrigation, resistant varieties",
    "severity": "moderate"
  },
  "Downy Mildew": {
    "hindi": "मृदुरोमिल आसिता",
    "crops": ["cucumber", "grape", "onion", "cauliflower", "spinach"],
    "symptoms": [
      "yellow spots on upper leaf surface",
      "grayish purple mold on undersides",
      "leaves become brown and dry",
      "stunted growth"
    ],
    "causes": "Oomycete pathogens (Peronospora, Pseudoperonospora), cool wet conditions",
    "treatment": "Mancozeb @ 2.5g/L or Metalaxyl + Mancozeb @ 2g/L or Copper Hydroxide @ 2g/L. Spray every 7-10 days.",
    "prevention": "Good drainage, avoid overhead irrigation, morning watering, crop rotation",
    "severity": "high"
  },
  "Fusarium Wilt": {
    "hindi": "फ्यूजेरियम उखटा रोग",
    "crops": ["tomato", "banana", "cotton", "chickpea", "pigeon pea"],
    "symptoms": [
      "yellowing starts from lower leaves",
      "one-sided wilting",
      "brown vascular bundles",
      "stunting",
      "leaf margin browning"
    ],
    "causes": "Fusarium oxysporum fungus, soil-borne, warm temperatures 25-30°C",
    "treatment": "Soil drenching with Carbendazim @ 2g/L or Trichoderma viride @ 5g/L. Seed treatment with Thiram @ 3g/kg.",
    "prevention": "Resistant varieties, crop rotation, soil solarization, biocontrol agents (Trichoderma)",
    "severity": "high"
  },
  "Anthracnose": {
    "hindi": "श्यामवर्ण रोग",
    "crops": ["mango", "papaya", "chilli", "grape", "banana"],
    "symptoms": [
    ...
    "causes": "Colletotrichum species fungi, high humidity, rainy season",
    "treatment": "Carbendazim @ 1g/L or Mancozeb @ 2.5g/L or Copper Oxychloride @ 3g/L. Spray 3-4 times during flowering.",
    "prevention": "Prune infected parts, remove mummies, avoid crowding, post-harvest hot water treatment",
    "severity": "high"
  },
  "Yellow Mosaic Virus": {
    "hindi": "पीला मोज़ेक विषाणु",
    "crops": ["okra", "mungbean", "urdbean", "soybean"],
    "symptoms": [
    ...
    "treatment": "No direct cure. Control vector with Imidacloprid @ 0.5ml/L or Thiamethoxam @ 0.3g/L. Remove infected plants.",
    "prevention": "Use resistant varieties, control whiteflies, remove weeds, use reflective mulches, intercropping with maize",
    "severity": "high"
  },
  "Leaf Curl Virus": {
    "hindi": "पत्ती मोड़क विषाणु",
    "crops": ["cotton", "tomato", "chilli", "papaya"],
    "symptoms": [
    ...
    "treatment": "Control whiteflies with Imidacloprid @ 0.5ml/L. Spray Neem oil 2% weekly as deterrent. Remove affected plants.",
    "prevention": "Resistant varieties, destroy volunteer plants, control whiteflies, avoid planting near infected crops",
    "severity": "critical"
  },
  "Rust Disease": {
    "hindi": "गेरुई रोग",
    "crops": ["wheat", "groundnut", "coffee", "bean", "soybean"],
    "symptoms": [
      "orange-brown pustules on leaves",
      "rusty powder on rubbing",
      "yellowing around pustules",
      "premature leaf drop"
    ],
    "causes": "Puccinia species fungi, cool humid conditions, dew formation",
    "treatment": "Propiconazole @ 1ml/L or Mancozeb @ 2.5g/L or Triadimefon @ 1g/L. Apply at first sign.",
    "prevention": "Resistant varieties, destroy volunteer crops, proper spacing, avoid late sowing",
    "severity": "high"
  },
  "Blast Disease": {
    "hindi": "झुलसा रोग",
    ...
    "causes": "Magnaporthe oryzae fungus, high humidity, excess nitrogen",
    "treatment": "Tricyclazole 75% WP @ 0.6g/L or Isoprothiolane @ 1.5ml/L. Spray at first symptom and repeat after 15 days.",
    "prevention": "Resistant varieties, balanced fertilizer (avoid excess N), seed treatment, field sanitation",
    "severity": "critical"
  },
  "Root Rot": {
    "hindi": "जड़ सड़न",
    "crops": ["chickpea", "lentil", "groundnut", "cotton", "soybean"],
    "symptoms": [
    ...
    "causes": "Rhizoctonia, Fusarium, Macrophomina fungi, waterlogging, poor drainage",
    "treatment": "Seed treatment with Carbendazim + Thiram @ 2g/kg. Soil application of Trichoderma @ 5kg/acre.",
    "prevention": "Good drainage, avoid waterlogging, crop rotation, biocontrol agents, seed treatment",
    "severity": "high"
  },
  "Damping Off": {
    "hindi": "आर्द्र गलन",
    "crops": ["tomato seedlings", "chilli seedlings", "brinjal seedlings", "cabbage seedlings"],
    "symptoms": [
      "seedlings falling over",
      "water-soaked stems at soil level",
      "thin dark stem base",
      "poor germination",
      "patches of dead seedlings"
    ],
    "causes": "Pythium, Rhizoctonia, Fusarium fungi, overwatering, poor drainage, overcrowding",
    "treatment": "Drench with Metalaxyl @ 2g/L or Copper Oxychloride @ 3g/L. Reduce watering.",
    "prevention": "Sterilize soil, avoid overwatering, thin seedlings, good drainage, Trichoderma application",
    "severity": "high"
  },
  "Bacterial Leaf Blight": {
    ...
    "crops": ["rice"],
    "symptoms": [
      "water-soaked lesions at leaf tips",
      "yellow to white streaks along veins",
      "leaves turn straw colored",
      "wilting of seedlings"
    ],
    "causes": "Xanthomonas oryzae bacteria, heavy rains, flooding, wounds",
    "treatment": "Streptocycline @ 100ppm + Copper Oxychloride @ 3g/L. Spray 2-3 times at 10 day interval.",
    "prevention": "Resistant varieties, avoid excess nitrogen, balanced K fertilization, seed treatment",
    "severity": "high"
  },
  "Stem Borer Damage": {
    "hindi": "तना छेदक",
    "crops": ["rice", "maize", "sugarcane", "sorghum"],
    "symptoms": [
    ...
    "causes": "Various stem borer insects (Scirpophaga, Chilo species)",
    "treatment": "Carbofuran 3G @ 12kg/acre in whorl. Spray Chlorpyriphos @ 2.5ml/L or Cartap Hydrochloride @ 2g/L.",
    "prevention": "Light traps, pheromone traps, destroy stubbles, avoid ratoon crops, release Trichogramma",
    "severity": "high"
  },
  "Nitrogen Deficiency": {
    ...
    "causes": "Insufficient nitrogen in soil, leaching, waterlogging",
    "treatment": "Apply Urea @ 20-30 kg/acre or 2% Urea foliar spray. Split application recommended.",
    "prevention": "Soil testing, balanced fertilization, organic matter addition, nitrification inhibitors",
    "severity": "moderate"
  },
  "Phosphorus Deficiency": {
    "hindi": "फॉस्फोरस की कमी",
    "crops": ["all crops"],
    "symptoms": [
    ...
    "causes": "Low soil phosphorus, high pH fixing P, cold soils",
    "treatment": "Apply DAP @ 50 kg/acre or SSP @ 100 kg/acre basal. Foliar spray of 2% DAP.",
    "prevention": "Soil testing, adequate P at planting, mycorrhizal inoculation",
    "severity": "moderate"
  },
  "Potassium Deficiency": {
    ...
    "causes": "Low soil K, sandy soils, heavy K-demanding crops",
    "treatment": "Apply MOP (Muriate of Potash) @ 40 kg/acre or SOP @ 50 kg/acre. Foliar KCl 1%.",
    "prevention": "Soil testing, adequate K fertilization, avoid excess Na",
    "severity": "moderate"
  },
  "Iron Deficiency": {
    "hindi": "लोहे की कमी",
    "crops": ["rice", "groundnut", "citrus", "grape"],
    "symptoms": [
      "interveinal chlorosis on young leaves",
      "yellowing between green veins",
      "white leaves in severe cases",
      "stunted growth"
    ],
    "causes": "High pH soil (>7.5), calcareous soils, excess phosphorus",
    "treatment": "Foliar spray of Ferrous Sulphate @ 0.5% + Citric Acid 0.1% or Fe-EDTA @ 0.2%.",
    "prevention": "Acidify root zone with sulfur, avoid overliming, Fe-fortified fertilizers",
    "severity": "moderate"
  },
  "Zinc Deficiency": {
    "hindi": "जिंक की कमी",
    ...
    "causes": "High pH, sandy soils, high phosphorus, continuous flooded rice",
    "treatment": "Soil application of Zinc Sulphate @ 10 kg/acre or foliar spray @ 0.5%.",
    "prevention": "Regular Zn application, avoid excess P, soil testing, Zn-coated fertilizers",
    "severity": "moderate"
  }
}
...
## `backend/data/knowledge/pests.json`
...
```json
{
  "Aphids": {
    "hindi": "माहू",
    "crops": ["cotton", "wheat", "mustard", "cabbage", "okra", "chilli"],
    "identification": "Small soft-bodied insects, green/black/brown, found in clusters on undersides of leaves and growing tips",
    "damage": "Sucks plant sap, causes leaf curling, stunted growth, secretes honeydew leading to sooty mold, transmits viruses",
    "treatment": "Imidacloprid 17.8% SL @ 0.5ml/L or Dimethoate @ 2ml/L or Thiamethoxam 25% WG @ 0.3g/L. Spray on undersides.",
    "organic_control": "Neem oil 2% spray, Yellow sticky traps, Release ladybird beetles (Coccinella), Soap spray 1%",
    "natural_enemies": ["Ladybird beetles", "Lacewings", "Syrphid flies", "Parasitic wasps"],
    "severity": "moderate"
  },
  "Whiteflies": {
    "hindi": "सफेद मक्खी",
    "crops": ["cotton", "tomato", "brinjal", "okra", "chilli", "cucumber"],
    "identification": "Tiny white moth-like insects, fly when leaves are disturbed, found on leaf undersides",
    "damage": "Sucks sap, causes yellowing, transmits Yellow Mosaic Virus and Leaf Curl Virus, honeydew secretion",
    "treatment": "Spiromesifen 22.9% SC @ 0.4ml/L or Pyriproxyfen @ 1.5ml/L or Acetamiprid 20% SP @ 0.3g/L. Spray in morning.",
    "organic_control": "Yellow sticky traps (20-25/acre), Neem oil 2%, Reflective mulches, Intercrop with maize",
    "natural_enemies": ["Encarsia formosa (parasitic wasp)", "Chrysoperla"],
    "severity": "critical"
  },
  "Thrips": {
    "hindi": "थ्रिप्स",
    "crops": ["onion", "garlic", "chilli", "grape", "cotton", "groundnut"],
    "identification": "Tiny slender insects (1-2mm), yellow/brown/black, rasping mouthparts",
    "damage": "Silvery patches on leaves, distorted leaves, curling, reduced plant vigor, transmits viruses (IYSV in onion)",
    "treatment": "Fipronil 5% SC @ 1.5ml/L or Spinosad 45% SC @ 0.3ml/L or Carbosulfan @ 2ml/L. Spray covers undersides.",
    "organic_control": "Blue sticky traps, Neem oil 2%, Beauveria bassiana @ 5g/L, Avoid overhead irrigation",
    "natural_enemies": ["Orius bugs", "Predatory thrips", "Lacewings"],
    "severity": "high"
  },
  "Red Spider Mites": {
    "hindi": "लाल मकड़ी",
    "crops": ["brinjal", "okra", "cotton", "tomato", "chilli", "tea"],
    "identification": "Tiny red/yellow/green mites, webbing on leaves, visible with magnifying glass",
    "damage": "Stippling on leaves, bronzing, webbing, reduced photosynthesis, leaf drop in severe cases",
    "treatment": "Dicofol @ 2.5ml/L or Wettable Sulphur @ 3g/L or Propargite @ 2ml/L or Spiromesifen. Rotate chemicals.",
    "organic_control": "Neem oil + Sulphur spray, Increase humidity, Release predatory mites (Phytoseiulus), Water spray",
    "natural_enemies": ["Phytoseiulus persimilis", "Stethorus beetles", "Lacewings"],
    "severity": "high"
  },
  "Fruit Borer": {
    "hindi": "फल छेदक",
    "crops": ["tomato", "brinjal", "okra", "chickpea", "pigeonpea"],
    "identification": "Greenish caterpillars with dark stripes, bore into fruits leaving holes with frass",
    "damage": "Bores into fruits causing rotting, reduces marketable yield significantly (up to 60% loss)",
    "treatment": "Indoxacarb 14.5% SC @ 0.5ml/L or Chlorantraniliprole 18.5% SC @ 0.3ml/L or Emamectin Benzoate @ 0.4g/L.",
    "organic_control": "Pheromone traps (20/acre), Bacillus thuringiensis (Bt) @ 2g/L, Neem seed kernel extract 5%, Hand picking",
    "natural_enemies": ["Trichogramma chilonis (egg parasitoid)", "Bracon species", "Cotesia species"],
    "severity": "critical"
  },
  "American Bollworm": {
    "hindi": "अमेरिकन बोलवर्म",
    "crops": ["cotton", "chickpea", "tomato", "pigeonpea", "maize"],
    "identification": "Caterpillars green to brown with lateral stripes, robust build, feeds on bolls/pods/fruits",
    "damage": "Bores into cotton bolls, chickpea pods, causes yield loss 30-80%, economic pest",
    "treatment": "HaNPV @ 250 LE/acre + Neem 2%, Spinosad @ 0.3ml/L, Indoxacarb @ 0.5ml/L. Apply in evening.",
    "organic_control": "Pheromone traps, HaNPV (Helicoverpa Nuclear Polyhedrosis Virus), Bt @ 2g/L, Crop rotation with non-host",
    "natural_enemies": ["Trichogramma", "Campoletis chlorideae", "Bracon hebetor"],
    "severity": "critical"
  },
  "Pink Bollworm": {
    "hindi": "गुलाबी बोलवर्म",
    "crops": ["cotton"],
    "identification": "Pinkish caterpillars inside cotton bolls, rosetted and loculi damaged",
    "damage": "Damages cotton bolls internally, reduces lint quality, causes pre-harvest boll shedding",
    "treatment": "Chlorantraniliprole @ 0.3ml/L or Flubendiamide @ 0.2ml/L. Spray at 50% flowering and repeat.",
    "organic_control": "Mating disruption with pheromones, Destroy crop residues by Nov 30, Deep ploughing, Bt cotton",
    "natural_enemies": ["Trichogramma", "Bracon spp"],
    "severity": "critical"
  },
  "Stem Borer (Rice)": {
    "hindi": "तना छेदक",
    "crops": ["rice", "maize", "sugarcane", "sorghum"],
    "identification": "Yellow/white larvae boring into stems, dead hearts in vegetative stage, white ears at heading",
    "damage": "Dead heart (tillers dry), white ear heads (no grain fill), 10-30% yield loss",
    "treatment": "Cartap Hydrochloride 4G @ 10 kg/acre or Chlorantraniliprole 0.4G @ 5 kg/acre. Apply in sitting water.",
    "organic_control": "Release Trichogramma japonicum (50,000/acre), Light traps, Destroy stubbles, Clip leaf tips",
    "natural_enemies": ["Trichogramma japonicum", "Telenomus", "Tetrastichus"],
    "severity": "high"
  },
  "Brown Plant Hopper": {
    "hindi": "भूरा फुदका",
    "crops": ["rice"],
    "identification": "Brown wedge-shaped hoppers at plant base, nymphs and adults in large numbers",
    "damage": "Hopper burn (circular patches of dried plants), transmits viruses (grassy stunt, ragged stunt)",
    "treatment": "Pymetrozine @ 0.6g/L or Buprofezin @ 2ml/L or Dinotefuran @ 0.3g/L. Spray at plant base, not on foliage.",
    "organic_control": "Drain water for 3-5 days, Avoid excess nitrogen, Spider conservation, Use resistant varieties",
    "natural_enemies": ["Lycosa spiders", "Cyrtorhinus lividipennis", "Mirid bugs"],
    "severity": "critical"
  },
  "Leaf Folder": {
    "hindi": "पत्ती लपेटक",
    "crops": ["rice"],
    "identification": "Caterpillars fold leaves longitudinally and feed inside, white linear feeding marks",
    "damage": "Reduces photosynthesis, white streaks on leaves, affects grain filling at later stage",
    "treatment": "Chlorantraniliprole @ 0.3ml/L or Cartap Hydrochloride @ 2g/L or Flubendiamide @ 0.2ml/L.",
    "organic_control": "Hand collection, Light traps, Release Trichogramma, Bt spray @ 2g/L, Avoid excess N",
    "natural_enemies": ["Trichogramma chilonis", "Cotesia angustibasis", "Ichneumon wasps"],
    "severity": "moderate"
  },
  "Pod Borer (Chickpea)": {
    "hindi": "फली छेदक",
    "crops": ["chickpea", "pigeonpea", "greengram", "blackgram"],
    "identification": "Greenish caterpillars with dark lines, feed on pods creating circular holes",
    "damage": "Destroys developing seeds, 30-80% pod damage in severe cases",
    "treatment": "Indoxacarb @ 0.5ml/L or Spinosad @ 0.3ml/L. Spray at 50% flowering and 10 days later.",
    "organic_control": "HaNPV @ 250 LE/acre, Bt @ 2g/L, Bird perches (20/acre), Intercrop with coriander",
    "natural_enemies": ["Campoletis chlorideae", "Bracon spp", "Trichogramma"],
    "severity": "critical"
  },
  "Diamondback Moth": {
    "hindi": "डायमंड बैक मॉथ",
    "crops": ["cabbage", "cauliflower", "broccoli", "radish", "mustard"],
    "identification": "Small greenish caterpillars, wriggle backward when disturbed, diamond pattern on adult moth",
    "damage": "Skeletonizes leaves, damages heads, reduces marketability",
    "treatment": "Spinosad @ 0.3ml/L or Chlorantraniliprole @ 0.3ml/L or Emamectin Benzoate @ 0.4g/L. Rotate insecticides.",
    "organic_control": "Bt spray @ 2g/L, Mustard as trap crop, Pheromone traps, Neem seed extract 5%",
    "natural_enemies": ["Diadegma semiclausum", "Cotesia plutellae", "Apanteles plutellae"],
    "severity": "high"
  },
  "Cutworm": {
    "hindi": "कटवा कीट",
    "crops": ["tomato", "tobacco", "cabbage", "maize", "vegetables"],
    "identification": "Fleshy gray-brown caterpillars, curl when touched, hide in soil during day",
    "damage": "Cuts seedlings at soil level at night, patchy gaps in crop stand",
    "treatment": "Poison bait (Wheat bran + Carbaryl), Chlorpyriphos @ 3ml/L drench around plants, Quinalphos 1.5D dust.",
    "organic_control": "Collect and destroy at night with torch, Flooding fields, Deep tillage to expose larvae, Neem cake in soil",
    "natural_enemies": ["Ground beetles (Carabids)", "Parasitic wasps", "Birds"],
    "severity": "moderate"
  },
  "Shoot Fly (Sorghum)": {
    "hindi": "तना मक्खी",
    "crops": ["sorghum", "maize"],
    "identification": "Small gray flies, maggots bore into central shoot of young plants",
    "damage": "Dead heart in 2-4 week old seedlings, tillers are attacked subsequently",
    "treatment": "Seed treatment Imidacloprid 70% WS @ 10g/kg. Spray Carbofuran 3G in whorl @ 8 kg/acre. Dimethoate @ 2ml/L.",
    "organic_control": "Early sowing (before July 20), High seed rate, Remove and destroy dead hearts, Fish meal trap",
    "natural_enemies": ["Parasitoids (Aprostocetus)", "Spiders"],
    "severity": "high"
  },
  "Jassids (Leafhoppers)": {
    "hindi": "हरा तेला",
    "crops": ["cotton", "brinjal", "okra", "groundnut"],
    "identification": "Small wedge-shaped green insects, move sideways on leaves, quick jumpers",
    "damage": "Yellowing of leaf margins (hopper burn), curling downward, reduced plant vigor",
    "treatment": "Imidacloprid @ 0.5ml/L or Fipronil @ 1.5ml/L or Acetamiprid @ 0.2g/L. Spray on lower leaf surface.",
    "organic_control": "Neem oil 2%, Yellow sticky traps, Intercropping with onion, Resistant varieties",
    "natural_enemies": ["Spiders", "Mirid bugs", "Lacewings", "Lady beetles"],
    "severity": "moderate"
  },
  "Mealy bugs": {
    "hindi": "मिली बग",
    "crops": ["cotton", "grape", "mango", "papaya", "hibiscus"],
    "identification": "White cottony insects in clusters, covered with waxy secretion, nymphs pink",
    "damage": "Sucks sap, stunts growth, honeydew causes sooty mold, deforms fruits, vector of viruses",
    "treatment": "Profenophos @ 2ml/L or Chlorpyriphos @ 2ml/L + Fish oil rosin soap. Spray to run-off.",
    "organic_control": "Release Cryptolaemus beetles, Neem oil soap spray, Remove ant colonies, High pressure water spray",
    "natural_enemies": ["Cryptolaemus montrouzieri (Australian ladybird)", "Leptomastix dactylopii"],
    "severity": "high"
  },
  "Termites": {
    "hindi": "दीमक",
    "crops": ["sugarcane", "wheat", "groundnut", "maize", "cotton"],
    "identification": "White soft-bodied insects in soil, mud tubes on stems/roots",
    "damage": "Hollows out roots and stems, sudden wilting, plant lodging, underground damage",
    "treatment": "Chlorpyriphos 20EC @ 2L/acre with irrigation or Imidacloprid 17.8SL @ 500ml/acre. Soil drench.",
    "organic_control": "Neem cake @ 250kg/acre, Deep ploughing, Remove crop residues, Avoid organic matter at sowing",
    "natural_enemies": ["Ants", "Nematodes", "Fungal pathogens"],
    "severity": "high"
  },
  "Grasshoppers": {
    "hindi": "टिड्डी",
    "crops": ["rice", "maize", "sorghum", "millet", "vegetables"],
    "identification": "Large jumping insects, green or brown, consume large amounts of foliage",
    "damage": "Defoliates crops, consumes large leaf areas, swarms cause devastating damage",
    "treatment": "Chlorpyriphos @ 2.5ml/L or Malathion @ 2ml/L. In swarm situations, coordinate with government.",
    "organic_control": "Deep ploughing to expose eggs, Birds encourage, Neem products, Metarhizium acridum (Green Muscle)",
    "natural_enemies": ["Birds", "Robber flies", "Parasitic flies"],
    "severity": "moderate"
  },
  "Root Knot Nematodes": {
    "hindi": "जड़ गांठ सूत्रकृमि",
    "crops": ["tomato", "brinjal", "okra", "carrot", "cucumber"],
    "identification": "Galls/knots on roots, stunted plants, wilting in afternoon, patchy growth in field",
    "damage": "Root damage, nutrient/water uptake reduced, secondary infections, 20-50% yield loss",
    "treatment": "Carbofuran 3G @ 10kg/acre at transplanting. Dazomet/Metam sodium for nursery fumigation.",
    "organic_control": "Marigold intercrop, Paecilomyces lilacinus @ 5kg/acre, Neem cake @ 200kg/acre, Solarization",
    "natural_enemies": ["Paecilomyces lilacinus", "Pochonia chlamydosporia", "Purpureocillium"],
    "severity": "high"
  },
  "Fruit Fly": {
    "hindi": "फल मक्खी",
    "crops": ["mango", "guava", "cucurbits", "citrus", "tomato"],
    "identification": "Adults are small flies with patterned wings, maggots inside fruits",
    "damage": "Maggots feed inside fruits, fruit drop, rotting, export rejection",
    "treatment": "Protein bait (Malathion 50EC 10ml + Jaggery 100g + Water 1L) spray on one meter area on alternate plants.",
    "organic_control": "Methyl eugenol traps (25/acre), Pheromone traps, Collect and destroy fallen fruits, Bagging fruits",
    "natural_enemies": ["Parasitic wasps (Opius)", "Predatory ants"],
    "severity": "high"
  }
}
